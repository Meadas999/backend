...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.jet.appback.AppBackApplicationTests", () -> new AotSpringBootConfigContextLoader(AppBackApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.jet.appback.AppBackApplicationTests", AppBackApplicationTestsContextInitializer.class);
    return entries;
  }
}
